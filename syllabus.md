...
The class is designed to cover a broader range of topics, exposing you to the landscape of HPC and laying a foundation that imbues you with an understanding of what's possible. That breadth comes at the expense of depth: we don't have the time to make you a master of [MPI](readings/mpi.md) or [GPU](readings/gpu-programming.md) programming, but we will give you enough of an introduction that you know what to continue learning when faced with problems amenable to acceleration by supercomputing.
